export const PLAYER_PLAY: string = 'PLAYER_PLAY'; // 播放音乐
export const PLAYER_ADD: string = 'PLAYER_ADD'; // 添加音乐进播放列表
export const PLAYER_SET_PLAYLIST: string = 'PLAYER_SET_PLAYLIST'; // 设置播放列表
export const PLAYER_SWITCH: string = 'PLAYER_SWITCH'; // 切换音乐
